...
class bina_Service_Provider_Conflicts_Shell_Widget extends Widget_Base {

	public function get_name() {
		return 'bina_service_provider_conflicts_shell';
	}

	public function get_title() {
		return __( 'Service Provider — النزاعات', 'bina' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'url_conflicts', array( 'label' => __( 'النزاعات (هذه الصفحة)', 'bina' ), 'type' => Controls_Manager::URL, 'default' => $u( '/service-provider-conflicts' ) ) );
