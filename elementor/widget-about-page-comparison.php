...
class bina_About_Page_Comparison_Widget extends Widget_Base {
    ...
    protected function _register_controls(){
        ...
        $this->add_control('title',['type'=>Controls_Manager::TEXT,'default'=>'كيف تختلف بناء  عن الطرق التقليدية؟']);
        ...
        $this->add_control('rows',['type'=>Controls_Manager::REPEATER,'fields'=>$r->get_controls(),'default'=>[
            ...
            ['left'=>'لا يوجد توثيق أو ضمان في الاتفاق','right'=>'إمكانية طلب توثيق ومتابعة من بناء '],
