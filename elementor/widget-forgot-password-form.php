...
class bina_Forgot_Password_Form_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		$this->start_controls_section( 'sec_content', array( 'label' => __( 'Content', 'bina' ) ) );
		$this->add_control( 'title', array( 'label' => __( 'Title', 'bina' ), 'type' => Controls_Manager::TEXT, 'default' => 'استعادة كلمة المرور' ) );
		$this->add_control( 'desc', array( 'label' => __( 'Description', 'bina' ), 'type' => Controls_Manager::TEXTAREA, 'default' => 'أدخل بريدك الإلكتروني لإرسال رابط إعادة تعيين كلمة المرور' ) );
		$this->add_control( 'email_label', array( 'label' => __( 'Email Label', 'bina' ), 'type' => Controls_Manager::TEXT, 'default' => 'البريد الإلكتروني' ) );
		$this->add_control( 'email_placeholder', array( 'label' => __( 'Email Placeholder', 'bina' ), 'type' => Controls_Manager::TEXT, 'default' => 'name@example.com' ) );
		$this->add_control( 'email_help', array( 'label' => __( 'Email Help Text', 'bina' ), 'type' => Controls_Manager::TEXTAREA, 'default' => 'سنرسل رابط إعادة تعيين كلمة المرور إذا كان هناك حساب مرتبط بهذا البريد الإلكتروني.' ) );
		$this->add_control( 'button_text', array( 'label' => __( 'Button Text', 'bina' ), 'type' => Controls_Manager::TEXT, 'default' => 'إرسال رابط إعادة التعيين' ) );
		$this->add_control( 'login_text', array( 'label' => __( 'Login Link Text', 'bina' ), 'type' => Controls_Manager::TEXT, 'default' => 'تسجيل الدخول' ) );
		$this->add_control( 'login_url', array( 'label' => __( 'Login URL', 'bina' ), 'type' => Controls_Manager::URL, 'default' => array( 'url' => '/login' ) ) );
