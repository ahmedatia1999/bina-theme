...
class bina_Service_Provider_Payments_Shell_Widget extends Widget_Base {

	public function get_name() {
		return 'bina_service_provider_payments_shell';
	}

	public function get_title() {
		return __( 'Service Provider — المدفوعات (Wallet)', 'bina' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'url_payments', array( 'label' => __( 'المدفوعات (هذه الصفحة)', 'bina' ), 'type' => Controls_Manager::URL, 'default' => $u( '/service-provider-payments' ) ) );
