...
class bina_Engineers_CTA_Widget extends Widget_Base {

    public function get_name() {
        return 'bina_engineers_cta';
    }

    public function get_title() {
        return __('Engineers CTA (Static)', 'bina');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control('heading', [
            ...
            'default' => __('سجّل الآن وابدأ باستقبال المشاريع', 'bina'),
        ]);
        ...
        $this->add_control('description', [
            ...
            'rows' => 2,
            'default' => __('انضم لشبكة المهندسين الشركاء واحصل على مشاريع حقيقية في مدينتك', 'bina'),
        ]);
            ...
            <div class="container-custom relative z-10">
                <div class="" style="opacity: 1; transform: none;">
                    <div class="text-center max-w-3xl mx-auto">
                        <div class="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center mx-auto mb-6" style="transform: scale(1.09578);">
